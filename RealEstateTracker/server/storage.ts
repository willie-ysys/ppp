...
export class MemStorage implements IStorage {
  ...
  async getExpiringItems(days: number): Promise<FoodItem[]> {
  ...
  async getExpiringItemsCount(days: number): Promise<number> {
    const expiringItems = await this.getExpiringItems(days);
